...
export default interface PortalTable {
  ...
  webhook_channel_id: ColumnType<string | null, string | null, string | null>;

  webhook_resource_id: ColumnType<string | null, string | null, string | null>;

  webhook_channel_token: ColumnType<string | null, string | null, string | null>;
